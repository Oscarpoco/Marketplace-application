...
export const LoginUser = async (req, res) => {
    try {
        ...
        res.status(200).json({ message: "User logged in successfully", id: fetchUser.id, email: fetchUser.email, token: userToken });
        console.log({ message: "User logged in successfully", id: fetchUser.id, email: fetchUser.email, token: userToken });
    } catch (error) {
